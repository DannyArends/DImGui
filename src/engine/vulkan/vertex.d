...
struct Vertex {
  ...
  @nogc static VkVertexInputAttributeDescription[15] getRenderDescriptions() nothrow {
    VkVertexInputAttributeDescription[15] attributeDescriptions = [
      ...
      { binding: INSTANCE, location: 7, format: VK_FORMAT_R32G32B32A32_SFLOAT, offset: DrawInstance.instance.offsetof },
      { binding: INSTANCE, location: 8, format: VK_FORMAT_R32G32B32A32_SFLOAT, offset: DrawInstance.uvRect.offsetof },

      { binding: INSTANCE, location: 9, format: VK_FORMAT_R32G32B32A32_SFLOAT, offset: DrawInstance.worldNormal.offsetof },
      { binding: INSTANCE, location: 10, format: VK_FORMAT_R32G32B32A32_SFLOAT, offset: DrawInstance.worldTangent.offsetof },
  ...
  @nogc static VkVertexInputAttributeDescription[8] getShadowDescriptions() nothrow {
    VkVertexInputAttributeDescription[8] attributeDescriptions = [
      ...
      {binding: INSTANCE, location: 3, format: VK_FORMAT_R32G32B32A32_SFLOAT, offset: DrawInstance.instance.offsetof },
