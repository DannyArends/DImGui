...
enum ResourceType : ubyte {
  ...
  @ResourceT("Sand_01",          true,  false, 1, 2.0f) Sand01,
  @ResourceT("Sand_02",          true,  false, 1, 2.0f) Sand02,
  @ResourceT("Sand_03",          true,  false, 1, 2.5f) Sand03,
  @ResourceT("Sand_05",          true,  false, 1, 3.5f) Sand05,
  @ResourceT("Gravel_01",        true,  false, 1, 1.5f) Gravel,
  @ResourceT("Moss_01",          true,  false, 1, 1.0f) Moss01,
  @ResourceT("Ground_08",        true,  false, 1, 1.0f) Ground08,
  @ResourceT("Grass_01",         true,  false, 1, 1.0f) Grass01,
  @ResourceT("Grass_02",         true,  false, 1, 1.0f) Grass02,
  @ResourceT("Grass_03",         true,  false, 1, 1.0f) Grass03,
  @ResourceT("Grass_04",         true,  false, 1, 1.0f) Grass04,
  @ResourceT("Forest_Ground_01", true,  false, 1, 2.0f) Forest01,
  @ResourceT("Jungle_01",        true,  false, 1, 2.9f) Forest02,
