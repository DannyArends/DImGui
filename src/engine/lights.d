...
enum Lights : Light {
  ...
  Red   = Light([-5.0f,  10.0f, -5.0f, 1.0f], [4.0f, 2.0f, 0.0f, 1.0f], [1.0f, -0.95f, 1.0f, 0.0f], [0.0f, 0.01f, 45.0f, 0.0f]),
  Green = Light([-5.0f,  10.0f, -5.0f, 1.0f], [0.0f, 4.0f, 2.0f, 1.0f], [0.0f, -0.95f, 1.0f, 0.0f], [0.0f, 0.01f, 45.0f, 0.0f]),
  Blue  = Light([-5.0f,  10.0f, -5.0f, 1.0f], [2.0f, 0.0f, 4.0f, 1.0f], [1.0f, -0.95f, 0.0f, 0.0f], [0.0f, 0.01f, 45.0f, 0.0f])
};
