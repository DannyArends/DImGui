...
struct Vertex {
  ...
  @nogc static VkVertexInputAttributeDescription[11] getAttributeDescriptions() nothrow {
    VkVertexInputAttributeDescription[11] attributeDescriptions = [
      ...
      { binding: VERTEX, location: 6, format: VK_FORMAT_R8_SINT, offset: Vertex.tid.offsetof },

      { binding: INSTANCE, location: 7, format: VK_FORMAT_R32G32B32A32_SFLOAT, offset: Instance.matrix.offsetof },
      { binding: INSTANCE, location: 8, format: VK_FORMAT_R32G32B32A32_SFLOAT, offset: Instance.matrix.offsetof + 4 * float.sizeof },
      { binding: INSTANCE, location: 9, format: VK_FORMAT_R32G32B32A32_SFLOAT, offset: Instance.matrix.offsetof + 8 * float.sizeof },
      { binding: INSTANCE, location: 10, format: VK_FORMAT_R32G32B32A32_SFLOAT, offset: Instance.matrix.offsetof + 12 * float.sizeof }
    ];
